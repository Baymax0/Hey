...
class SwiftNotice: NSObject {
    ...
    @discardableResult
    static func noticeOnStatusBar(_ text: String, autoClear: Bool, autoClearTime: TimeInterval) -> UIWindow{
        ...
        UIView.animate(withDuration: 0.3, animations: {
            ...
            if autoClear {
                self.perform(.hideNotice, with: window, afterDelay: autoClearTime)
            }
        })
        return window
    }
