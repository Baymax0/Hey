...
class BubbleTabBarControllerMy: BubbleTabBarController {
    ...
    override func viewDidLoad() {
        ...
        let three = ThreeVC()
        three.tabBarItem = self.getItem(title: "Events", image: #imageLiteral(resourceName: "tabbar-folder"), selectedImage: nil, color: #colorLiteral(red: 0.1960784346, green: 0.3411764801, blue: 0.1019607857, alpha: 1))
